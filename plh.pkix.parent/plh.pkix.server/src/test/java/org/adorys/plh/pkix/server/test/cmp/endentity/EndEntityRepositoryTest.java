...
public class EndEntityRepositoryTest {
	...
	public void test() throws NoSuchAlgorithmException {
		...
		PrivateKeyHolder fpPrivateKeyHolder = new PrivateKeyHolder();
		CertificateStore fpCertificateStore = new CertificateStore();
		new KeyPairBuilder()
		...
		PrivateKey fpPrivateKey = fpPrivateKeyHolder.getPrivateKey(KeyIdUtils.getSubjectKeyIdentifierAsOctetString(fpSubjectCertificate));
		...
		PrivateKeyHolder ssPrivateKeyHolder = new PrivateKeyHolder();
		CertificateStore ssCertificateStore = new CertificateStore();
		new KeyPairBuilder()
		...
		X509CertificateHolder ssFpCertificate = V3CertificateUtils.makeV3Certificate(ssSubjectCertificate, 
				fpPrivateKey, fpSubjectCertificate, new Date(), DateUtils.addYears(new Date(), 1), PlhCMPSystem.getProvider());
