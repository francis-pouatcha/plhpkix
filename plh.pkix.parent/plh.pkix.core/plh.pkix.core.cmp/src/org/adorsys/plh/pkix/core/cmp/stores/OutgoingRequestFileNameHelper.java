...
public abstract class OutgoingRequestFileNameHelper {
	private static final int RADIX=16;
	private static final String FILEPARTSEPARATOR="_";

	public static String makeFileName(BigInteger certReqId, Date nextAction, String status, Date disposed){
		return certReqId.toString(RADIX) + FILEPARTSEPARATOR +DateInFileName.toFileName(nextAction)+ FILEPARTSEPARATOR+status+ FILEPARTSEPARATOR+DateInFileName.toFileName(disposed);
	}
	...
	public static Date getNextAction(String fileName){
		return getNextAction(getNameComponents(fileName));
	}
	...
	public static Date getNextAction(String[] nameComponents){
