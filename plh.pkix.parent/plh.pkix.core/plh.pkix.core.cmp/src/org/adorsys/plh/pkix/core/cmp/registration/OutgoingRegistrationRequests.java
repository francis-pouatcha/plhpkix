 ...
 *
 */
public class OutgoingRegistrationRequests {
	...
	private Map<BigInteger, OutgoingRegistrationRequestData> outgoingRequestCache = new HashMap<BigInteger, OutgoingRegistrationRequestData>();
	
	public OutgoingRegistrationRequests(FileWrapper accountDir) {
		this.rootDir = accountDir.newChild(DIRRELATIVEPATH);
	}

	public void storeRegistrationRequest(BigInteger certReqId, OutgoingRegistrationRequestData requestData){
		OutgoingRequest registrationRequest = requestData.getOutgoingRequest();
		OutgoingRequestHandle outgoingRequestHandle = new OutgoingRequestHandle(registrationRequest);
	...
	public OutgoingRegistrationRequestData loadPendingRequest(OutgoingRequestHandle pendingRequestHandle){		
		...
		OutgoingRegistrationRequestData pendingRequestData = new OutgoingRegistrationRequestData();
	...
	public OutgoingRegistrationRequestData loadRequest(BigInteger certRequestId){
